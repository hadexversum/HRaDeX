...
If we want to investigate on deep-level the wuality of fittness, we can check the intermediate results. Here, we present the fitting results on the coverage plot. The classficiation results are consistent in regions, therefore the aggregation is justified.
...
```{r}
HRaDeX::plot_3d_structure_hires(pdb_file_path = "../data/Model_eEF1Bgamma.pdb",
...
kin_dat_2 <- HRaDeX::prepare_kin_dat(alpha_dat, 
                                   state = "Complex_gamma_alpha_KSCN",
                                   time_0 = 0,
                                   time_100 = 1440)
